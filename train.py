...
def train_xe(model, dataloader, optim, data_):
    ...
    with tqdm(desc='Epoch %d - train' % e, unit='it', total=len(dataloader)) as pbar:
        for it, (detections, captions) in enumerate(dataloader):
            ...
            out = out[:, :-1].contiguous()
            loss = loss_fn(out.view(-1, data_.vocab_size), captions_gt.view(-1))
            loss.backward()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--features_path', default='./vocab.pkl', type=str)
    parser.add_argument('--annotation_folder', default='/media/storage/Datasets/coco/annotations', type=str)
    ...
    # Create the dataset
    # dataset = COCO(image_field, text_field, '/media/storage/Datasets/coco/images/', args.annotation_folder,
